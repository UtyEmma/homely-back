...
<html>
  <head>
    ...
    <title>Email verification from Bayof</title>
    <style>
      /* -------------------------------------
          GLOBAL RESETS
      ------------------------------------- */
              ...
              <tr>
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p style="text-transform:capitalize">{{ $greeting }},</p>
                        <p>You just created an account on Bayof, and we're glad to have you!<br>
                            To complete the process, just confirm your email by clicking the button below.</p>
                            ...
                            <tr>
                              <td align="center">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr align="center">
                                      <td> <a href="{{$links}}" target="_blank">Confirm Email</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
                        ...
                        <p>We can't wait to grant you access to the future of real estate.</p>
                        <p>Welcome onboard, Chief. <br> - Team Bayof </p>
                      </td>
                    </tr>
                  </table>
                </td>
