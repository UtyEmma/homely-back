        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-profile">
                        <div class="card-avatar bg-danger" style="overflow: hidden">
                            <img id="avatar" class="img-fluid" src="@php echo $agent->avatar ? json_decode($agent->avatar)[0] : asset('/images/faces/1.jpg') @endphp">
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <h5 class="card-title">Agent Profile Details</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
